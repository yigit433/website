...
export default function AnnouncementEmbed({ type = "info", message }) {
  const embedTypes = {
    info: {
      classN: "bg-blue-500 border-blue-500 text-blue-400",
      icon: <MdInfoOutline className="w-8 h-8" />,
    },
    success: {
      classN: "bg-green-500 border-green-500 text-green-400",
      icon: <IoCheckmarkDone className="w-8 h-8" />,
    },
    warning: {
      classN: "bg-orange-500 border-orange-500 text-orange-400",
      icon: <ImWarning className="w-8 h-8" />,
    },
    error: {
      classN: "bg-red-500 border-red-500 text-red-400",
